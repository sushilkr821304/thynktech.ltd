    ...
    return (
        <section id="about" className="relative w-full min-h-[600px] flex items-center overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10 py-16">
                <div className="max-w-3xl pl-4 md:pl-8 border-l-4 border-blue-500/0" data-aos="fade-right">

                    {/* Small Tag */}
                    <div className="inline-block px-3 py-1 mb-6 rounded-md bg-white/10 backdrop-blur-md border border-white/20">
                        <span className="text-white font-bold tracking-widest text-xs uppercase">ABOUT THYNKTECH</span>
                    </div>

                    {/* Big Heading */}
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight drop-shadow-sm">
                        About ThynkTech India
                    </h2>

                    {/* Sub-heading */}
                    <h3 className="text-xl md:text-2xl text-blue-100 font-medium mb-8 leading-relaxed">
